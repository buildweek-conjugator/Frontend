...
export default function ConjugatorGame() {
  ...
  function axiosGet() {
    axios
      .get(
        `https://conjugator-bw-api.herokuapp.com/api/verbs/${getRandomInt(638)}`
      )
      .then(response => {
  ...
  I created a the front end to a Spanish conjugation game with a teammate who built the corresponding backend. 

  I'm proud of writing this code as it was after two weeks of learning React and was my first React project I built
  from scratch. I used React hooks to store state and made the front-end more dynamic based on user input. 
  For example, in lines 141-152 and 206-217, I rendered a list of buttons with Spanish accented characters to 
  the user, and altered a form input based on what accented character was selected. I initially hardcoded 
  the accented character buttons and then later refactored it to make it DRY by mapping through chipData.
  */
          ...
          >
            ...
            <div className="subject-input-container">
              ...
              <TextField
                ...
                placeholder={
                  answer ? `${verb.answer}` : `Enter your conjugation`
                }
                value={input}
                margin="normal"
                variant="outlined"
